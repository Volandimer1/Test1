...
public static class AddressableTextMeshProFixer
{
    ...
    static void FixTextMeshPro()
    {
        ...
        var tmPro = Addressables.LoadAssetAsync<TMP_Settings>("TMP Settings").WaitForCompletion();
        ...
        var fontData = Addressables.LoadAssetAsync<TMP_FontAsset>("Fonts & Materials/LiberationSans SDF.asset").WaitForCompletion();
